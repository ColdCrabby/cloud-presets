...
import { MatchHighlight } from '@cloud-presets/ui';
import { App } from './app';
...
describe('App', () => {
  ...
  it('renders the brand header', async () => {
    ...
    expect(compiled.querySelector('.shell__brand-mark')?.textContent).toContain('Cold Crabby');
  });

  it('consumes the shared match-highlight primitive', async () => {
    const fixture = TestBed.createComponent(MatchHighlight);
